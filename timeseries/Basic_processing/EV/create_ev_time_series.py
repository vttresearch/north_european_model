...
def coefficient(coefficient_data, node_name:str):
...
def create_final_dataframes(df:pd.DataFrame, 
                            nodes_utc:list, 
                            nodes_with_coefficients:list, 
                            coefficient_data, 
        ...
        for node in nodes_utc[timezone]:
            if node in nodes_with_coefficients:
                if ts_name == 'ts_unit':
                    ...
                    colname = node + "_ev"
                    df[colname] = coefficient(coefficient_data, node) * ev_data_all_years_all_time_zones[timezone][ts_name]
...
def create_ev_timeseries(scenario, year):
    ...
    create_final_dataframes(ts_influx, 
                            country_nodes_utc, 
                            nodes_with_coefficients, 
                            coefficient_data, 
                            ev_data_all_years_all_time_zones,
                            timesteps,
                            'ts_influx')
    create_final_dataframes(ts_unit, 
                            country_nodes_utc, 
                            nodes_with_coefficients, 
                            coefficient_data, 
                            ev_data_all_years_all_time_zones,
                            timesteps,
                            'ts_unit') 
    create_final_dataframes(ts_node, 
                            country_nodes_utc, 
                            nodes_with_coefficients, 
                            coefficient_data, 
                            ev_data_all_years_all_time_zones,
