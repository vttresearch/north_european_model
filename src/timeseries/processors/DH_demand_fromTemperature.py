...
class DH_demand_fromTemperature(BaseProcessor):
    ...
    def _report_climate_spread(self, df_demands, built_nodes):
        ...
        docs/dh-demand-timeseries.md, not in the log.
        """
    ...
    def process(self) -> pd.DataFrame:
        ...
        # and most of a run's countries have no district heating. Nothing is said
        # unless *no* country has one, which is a build that produces nothing.
