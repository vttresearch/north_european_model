...
class hydro_inflow_MAF2019:
    ...
    def _process_reservoir_inflows(self, weekly_df):
        ...
        for country in self.country_codes:
            ...
            if df_country.empty:
                print("      No reservoir + psOpen inflow data for", country)
    ...
    def _process_ror_inflows(self, daily_df):
        ...
        for country in self.country_codes:
            ...
            if df_country.empty:
                print("      No Ror inflow data for", country)
    ...
    def run(self):
        ...
        print("   Processing reservoir inflows for all countries...")
        reservoir_all = self._process_reservoir_inflows(weekly_df)

        print("   Processing run-of-river inflows for all countries...")
