...
class PV_MAF2019:
    """
    Class to process PV capacity factor timeseries for countries.
    ...
    def run(self):
        ...
        input_file = os.path.join(self.input_folder, "PECD-MAF2019-wide-PV.csv")
        print(f"   Reading PV cf data from '{input_file}'.. ")
        if not os.path.isfile(input_file):
            print(f"Warning! Input file '{input_file}' not found, skipping PV time series!!!")
            return
